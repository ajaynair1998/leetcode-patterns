...
import { minSubArrayLen } from './lib/sliding-window/minimum.size.subarray';
...
//   3
// );
const answerToMinSubArr = minSubArrayLen(7, [2, 3, 1, 2, 4, 3]);
console.log('🚀 ~ file: index.ts:22 ~ answerToMinSubArr', answerToMinSubArr);
